...
def main() -> None:
    ...
    parser.add_argument("--tts-voice", default=None, help="Optional provider voice id recorded in cache metadata.")
    parser.add_argument("--tts-speed", type=float, default=None, help="Optional requested speaking speed recorded in metadata.")
