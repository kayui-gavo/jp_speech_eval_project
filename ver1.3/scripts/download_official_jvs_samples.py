...
Research preflights must use the phone override directly rather than re-G2P
either the surface or the kana and assume phoneme-exact preservation.
"""
...
# The phone target is stored in short lexical/morphological chunks so every
# phone index in a native false-alarm artifact can be traced back to a readable
# target segment. The two identical 明王/みょうおう chunks are deliberately
# identical at the logical-phone level.
TARGET_PHONE_SEGMENTS = (
    {"surface": "また", "reading": "また", "phones": ("m", "a", "t", "a")},
    {"surface": "東寺", "reading": "とうじ", "phones": ("t", "o", "o", "j", "i")},
    {"surface": "の", "reading": "の", "phones": ("n", "o")},
    {"surface": "ように", "reading": "ように", "phones": ("y", "o", "u", "n", "i")},
    {"surface": "五大", "reading": "ごだい", "phones": ("g", "o", "d", "a", "i")},
    {"surface": "明王", "reading": "みょうおう", "phones": ("my", "o", "o", "o", "o")},
    {"surface": "と", "reading": "と", "phones": ("t", "o")},
    {"surface": "呼ばれる", "reading": "よばれる", "phones": ("y", "o", "b", "a", "r", "e", "r", "u")},
    {"surface": "主要", "reading": "しゅよう", "phones": ("sh", "u", "y", "o", "o")},
    {"surface": "な", "reading": "な", "phones": ("n", "a")},
    {"surface": "明王", "reading": "みょうおう", "phones": ("my", "o", "o", "o", "o")},
    {"surface": "の", "reading": "の", "phones": ("n", "o")},
    {"surface": "中央", "reading": "ちゅうおう", "phones": ("ch", "u", "u", "o", "o")},
    {"surface": "に", "reading": "に", "phones": ("n", "i")},
    {"surface": "配される", "reading": "はいされる", "phones": ("h", "a", "i", "s", "a", "r", "e", "r", "u")},
    {"surface": "ことも", "reading": "ことも", "phones": ("k", "o", "t", "o", "m", "o")},
    {"surface": "多い", "reading": "おおい", "phones": ("o", "o", "i")},
)
TARGET_PHONES = tuple(
    phone
...
def _phone_index_metadata() -> tuple[dict[str, object], ...]:
    ...
    for segment_index, segment in enumerate(TARGET_PHONE_SEGMENTS):
        ...
        for segment_phone_index, phone in enumerate(segment_phones):
            rows.append(
                {
