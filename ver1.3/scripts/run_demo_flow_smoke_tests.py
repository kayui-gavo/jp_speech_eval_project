...
def _scenario_rows() -> List[Dict[str, Any]]:
    ...
    rows = [
        ...
        {"name": "fixed_clear_long_vowel_flag_off", "result": clear_short, "kwargs": {"special_mora_threshold_profile": "v2_limited_candidate"}, "expect": {"no_special_feedback": True}},
        {"name": "fixed_clear_long_vowel_flag_on_gentle", "result": clear_short, "kwargs": {"special_mora_threshold_profile": "v2_limited_candidate", "enable_user_facing_calibrated_special_mora": True}, "expect": {"status": "practice_suggestion", "suggestion_type": "special_mora"}},
