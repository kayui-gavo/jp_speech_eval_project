...
It uses only repository-bundled audio and never changes a product score.
"""
...
def main() -> None:
    ...
    payload = {
        "schema": "dual_ctc_candidate_preflight_v1",
        "model_id": args.model,
        "revision": args.revision,
        ...
        "interpretation": "engineering_shadow_preflight_not_l2_pronunciation_validity",
    }
