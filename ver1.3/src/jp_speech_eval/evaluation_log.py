...
def flatten_log_record(record: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    row: Dict[str, Any] = {
        ...
        "reference_id": input_info.get("reference_id"),
        "reference_source": input_info.get("reference_source"),
        "reference_provider": input_info.get("reference_provider"),
        "reference_model": input_info.get("reference_model"),
        "reference_voice": input_info.get("reference_voice"),
        "reference_config_hash": input_info.get("reference_config_hash"),
