...
## Proposed thresholds
- long_vowel: status=active, low=0.2307, high=1.0948 (P05/P95 conservative guardrail)
- sokuon: insufficient reliable alignment evidence; keep default/evidence-gated behavior
- moraic_nasal: status=active, low=0.2742, high=1.1429 (P05/P95 conservative guardrail)
- yoon: status=debug_only, low=0.8804, high=2.2489 (P05/P95 conservative guardrail)
